...
function initGame(){
    ...
    for (var i = 0; i < 5; i++){
        ...
        createBox(world, 150+(80*i-rand*rand), 360, 2*rand, 40+(rand*15), true, 'ground');    
    }
...
function showWin(){
    alert("You Win!!!");
    var resp = confirm('Do you want to play another match?');
    return resp;
}
...
function exit(){
    document.getElementById('console').innerHTML = "<h1>Closed! Thanks for Playing.</h1>";
}